...
export default function DeleteSoundButton(props: {
    ...
    return (
        <div className="group">
            <button
                className="my-auto ml-2 flex h-10 rounded-md bg-red-950 text-white transition-all hover:bg-red-800 active:bg-red-900 disabled:bg-red-300 disabled:text-black"
